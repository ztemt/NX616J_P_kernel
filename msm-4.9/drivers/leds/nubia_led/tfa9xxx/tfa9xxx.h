...
#define NUBIA_HAPTIC_TFA9XXX
#define PARALLEL_OBJECTS

#ifdef CONFIG_SND_SOC_TFA9874_OR_HAPTIC
#define Audio2Haptic_refGain
#endif
/* DSP init status */
...
struct tfa9xxx {
	...
	struct mutex dsp_lock, power_mutex;
	int dsp_init;
	int dsp_fw_state;
	int sysclk;
	int rst_gpio;
...
#endif
#ifdef NUBIA_HAPTIC_TFA9XXX
	struct tfa9xxx_pinctrl pinctrl_info;
#endif
};
