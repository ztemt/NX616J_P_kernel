...
#define NUBIA_TOUCH_RESUME_WORKQUEUE

/* macros definition */
#define GOODIX_CORE_DRIVER_NAME	"second_touch"
...
#define GOODIX_TS_PALM
#define GOODIX_TS_DYNAMIC_RESUME_SUSPEND
...
extern int gsx_gesture_get_status(void);
extern int goodix_unregister_gesture(void);
#endif
