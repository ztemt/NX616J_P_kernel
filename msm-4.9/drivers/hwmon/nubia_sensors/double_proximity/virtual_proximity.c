...
static ssize_t virtual_prox_thres_to_persist_store(struct device *dev,
                struct device_attribute *attr,
                const char *buf, size_t size)
{
    return size;
...
static struct device_attribute attrs_prox_device[] = {
	__ATTR(enable, 0664, virtual_proximity_enable_show, virtual_proximity_enable_store),
	__ATTR(proximity_fb,0640,proximity_fb_show,proximity_fb_store),
	__ATTR(prox_init, 0664, virtual_prox_dev_init_show, virtual_prox_dev_init_store),
	...
	__ATTR(prox_thres,0664, virtual_prox_thres_show, virtual_prox_thres_store),
	__ATTR(prox_debug, 0664, virtual_prox_raw_debug_show,  virtual_prox_raw_debug_store),
	...
	__ATTR(prox_first_event, 0664, virtual_offset_first_event_show,  virtual_offset_first_event_store),
	__ATTR(prox_offset_cal, 0664, virtual_prox_uncover_cal_show, virtual_prox_uncover_cal_store),
	__ATTR(debug, 0664, virtual_prox_debug_show,  virtual_prox_debug_store),
	__ATTR(prox_offset, 0440, virtual_prox_offset_show,NULL),
	__ATTR(prox_thres_to_persist, 0220, NULL, virtual_prox_thres_to_persist_store),
};
...
static void prox_fb_notifier_register(void){
    ...
    ret = msm_drm_panel_register_client(&vp_data->ps_fb_notify);
    if (ret < 0){
